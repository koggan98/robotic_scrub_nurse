...
def print_menu():
    ...
    print("  5 - Scissors (short) (RIGHT)")
    print("  6 - Retractor (small)")
    print("  8 - Holder Reclaim")
    print("  9 - Reclaim")
    print("=" * 40)
...
def main():
    ...
    try:
        while rclpy.ok():
            print_menu()
            try:
                tool_input = input("Enter tool number (0-6, 8 or 9): ").strip()
                if tool_input not in ['0', '1', '2', '3', '4', '5', '6', '8', '9']:
                    print("❌ Invalid input. Please enter a number between 0 and 6, or 8, or 9.")
                    continue
